          ...
          <SidebarGroupContent className="mt-0">
            <SidebarMenu>
              ...
              >
                <SidebarMenuButton
                  asChild
                  className="text-lg text-white space-x-2"
                >
                  <a>
              ...
              {/* <Collapsible defaultOpen>
                <CollapsibleTrigger className="py-5 w-full flex items-center text-lg text-white hover:bg-[#181818] transition-all duration-150 ease-linear">
                  <Edit className="ml-2 w-5 h-5" />
                  ...
                  <SidebarMenu>
                    <div className="mb-1">
                      ...
                      >
                        ...
                        >
                          <a>
                            <span className="text-base hover:text-red-500 text-white ml-7 flex">
                      ...
                      <SidebarMenuItem
                        className="my-2 py-1 hover:cursor-pointer hover:bg-[#181818] transition-all duration-150 ease-linear"
                        onClick={() => router.push("/Test")}
                      >
                        <SidebarMenuButton
                          asChild
                        ...
                        >
                          <a>
                            <span className="text-base text-white ml-7">
                              Image Upload
                            </span>
                          </a>
                        </SidebarMenuButton>
                ...
                <CollapsibleContent className="pl-4">
                  <SidebarMenu>
                    <div className="mb-1">
                      ...
                      <SidebarMenuItem className="my-2 py-1 hover:cursor-pointer hover:bg-[#181818] transition-all duration-150 ease-linear">
                        <SidebarMenuButton
                          asChild
                          className="text-lg text-white space-x-2"
                        >
              ...
              {user ? (
                <SidebarMenuItem className="py-5 hover:cursor-pointer hover:bg-[#181818] transition-all duration-150 ease-linear">
                  <SidebarMenuButton
                    asChild
                    className="text-lg text-white space-x-2"
